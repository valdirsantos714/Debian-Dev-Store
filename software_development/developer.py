...
class Dev:
    ...
    def __init__(self):
        self.funcionalidades = ['1 - Criar Projeto NodeJs + Typescript + PostgreSQL', "2 - Criar projeto React Native + Typescript + Tailwind CSS ", "3 - Criar Projeto React", "4 - ", "5 - Sair"]

        self.executadores = ["", self.nodejs_typescript_postgres, self.react_native_typescript, self.react_project]
